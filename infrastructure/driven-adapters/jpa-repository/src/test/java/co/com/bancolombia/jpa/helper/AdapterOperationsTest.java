...
import co.com.bancolombia.jpa.AnimalJPARepository;
import co.com.bancolombia.jpa.AnimalJPARepositoryAdapter;
...
class AdapterOperationsTest {
    ...
    @Mock
    private AnimalJPARepository repository;

    @Mock
    private ObjectMapper objectMapper;

    private AnimalJPARepositoryAdapter adapter;
    ...
    void setUp() {
        ...
        adapter = new AnimalJPARepositoryAdapter(repository, objectMapper);
    }
